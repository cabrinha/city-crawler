...
func (h *Pages) Routes(g *echo.Group) {
	g.GET("/", h.CityMap).Name = routenames.Home
	g.GET("/locations", h.Locations).Name = "locations"
	g.GET("/rankings", h.Rankings).Name = "rankings"
...
func (h *Pages) CityMap(ctx echo.Context) error {
	return pages.CityMap(ctx)
}

func (h *Pages) Locations(ctx echo.Context) error {
	return pages.Locations(ctx)
}

func (h *Pages) Rankings(ctx echo.Context) error {
	return pages.Rankings(ctx)
}
